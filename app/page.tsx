...
import { 
  Copy, Loader2, Download, Zap, Shield, Globe, 
  Play, CheckCircle2, Sparkles, Wand2 
} from "lucide-react";
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 md:px-6 md:py-14">
      ...
      <section className="relative overflow-hidden rounded-4xl border border-red-100 bg-linear-to-br from-red-50/50 via-white to-pink-50/30 px-6 py-14 shadow-[0_25px_80px_rgba(239,68,68,0.15)] md:px-10 md:py-20">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          <span className="inline-flex items-center rounded-full border border-red-200/70 bg-red-50/80 backdrop-blur-sm px-4 py-1.5 text-xs font-bold uppercase tracking-[0.2em] text-red-700 shadow-lg">
            ...
            <div className="flex flex-col gap-3 lg:flex-row">
              ...
              >
                {loading ? (
                  ...
                  <>
                    <Zap className="mr-2 h-6 w-6 group-hover:animate-zap" />
        ...
        <section className="mx-auto mt-8 max-w-4xl rounded-3xl border border-gray-200 bg-white p-6 shadow-xl md:p-8">
          <div className="flex flex-col items-center gap-4 lg:flex-row">
            <div className="relative shrink-0">
              ...
              >
                <Play className="absolute left-1/2 top-1/2 h-12 w-12 -translate-x-1/2 -translate-y-1/2 text-white shadow-2xl opacity-80 group-hover:scale-110" />
              </a>
            </div>
      ...
      <section className="mt-10">
        ...
        <AdUnit
          adSlot="1234567890"
          adFormat="auto"
          className="min-h-30 rounded-[28px] border border-gray-200/50 bg-white p-6 shadow-lg"
        />
      </section>
          ...
          <div className="flex flex-col gap-6 border-b border-gray-100/50 bg-linear-to-r from-red-50 via-white/80 to-pink-50/50 px-8 py-8 md:flex-row md:items-center md:justify-between">
            <div>
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-3xl font-black bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
                  Script Ready! ✅
                </h2>
              </div>
              <p className="mt-2 text-lg text-gray-600">
                Clean Hindi transcript ready है
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 md:justify-end">
              <button
                ...
                className="group flex items-center gap-3 rounded-2xl border-2 border-gray-200 bg-white px-6 py-3.5 text-lg font-bold text-gray-800 shadow-lg transition-all hover:border-gray-300 hover:shadow-xl active:scale-[0.98]"
              >
                <Copy className="h-5 w-5 group-hover:-translate-x-1 transition-transform" />
                {copied ? "Copied!" : "Copy Script"}
              </button>

              <button
                onClick={() => downloadScript(`original-${videoInfo?.title.slice(0, 30) || 'transcript'}.txt`, script)}
                className="group flex items-center gap-3 rounded-2xl bg-linear-to-r from-gray-900 to-black px-6 py-3.5 text-lg font-bold text-white shadow-2xl transition-all hover:from-gray-800 hover:shadow-3xl hover:shadow-gray-900/25 active:scale-[0.98]"
              >
      ...
      {script && !rewrittenScript && (
        <section className="mt-8 rounded-4xl border-2 border-purple-200/60 bg-linear-to-br from-purple-50 to-pink-50/50 p-8 shadow-2xl">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h2 className="mb-4 text-3xl font-black bg-linear-to-r from-purple-900 to-pink-700 bg-clip-text text-transparent">
              ✨ AI Rewrite करें?
            </h2>
            
            <p className="mx-auto mb-8 max-w-2xl text-xl text-gray-700 leading-relaxed">
              Same story को fresh words, strong hook और engaging style में बदलें। 
              <strong> नया script, वही content!</strong>
            </p>

            <button
              onClick={rewriteScript}
              disabled={rewriting}
              className="group relative mx-auto flex items-center gap-4 rounded-3xl bg-linear-to-r from-purple-600 via-pink-600 to-purple-700 px-12 py-6 text-xl font-black text-white shadow-2xl transition-all hover:scale-[1.02] hover:shadow-3xl hover:shadow-purple-500/25 disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-xl"
            >
              {rewriting ? (
                <>
                ...
                <>
                  <Wand2 className="h-6 w-6 group-hover:animate-magic" />
                  AI से Rewrite करें ✨
                </>
              )}
            </button>
      ...
      {rewrittenScript && (
        <section className="mt-8 rounded-4xl border border-purple-200/50 bg-linear-to-br from-purple-50/30 via-white to-pink-50/20 shadow-2xl">
          <div className="border-b border-purple-100/50 bg-linear-to-r from-purple-50/70 via-white/90 to-pink-50/50 px-8 py-8">
            <div className="flex items-center gap-3">
              <div className="h-4 w-4 rounded-full bg-linear-to-r from-purple-500 to-pink-500 shadow-lg animate-pulse"></div>
              <h2 className="text-3xl font-black bg-linear-to-r from-purple-900 via-pink-800 to-purple-800 bg-clip-text text-transparent">
          ...
          <div className="p-8">
            ...
            <div className="mb-8 rounded-2xl bg-linear-to-r from-purple-50 to-pink-50/50 p-6 shadow-lg">
              <h3 className="mb-3 flex items-center gap-2 text-sm font-bold uppercase tracking-wider text-purple-700">
                📌 नया Title
              </h3>
            ...
            <div className="mb-8 rounded-2xl border border-purple-100/50 bg-white/80 p-6 shadow-xl">
              ...
              <div className="whitespace-pre-wrap text-xl font-semibold text-gray-900 leading-relaxed">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                ...
                <div className="whitespace-pre-wrap rounded-2xl border border-purple-100/30 bg-linear-to-b from-white to-purple-50/30 p-6 text-lg text-gray-800 leading-relaxed shadow-xl">
            ...
            {/* CTA */}
            <div className="mt-8 rounded-2xl bg-linear-to-r from-emerald-50 to-green-50/50 border border-emerald-200/50 p-6 shadow-xl">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <button
                ...
                className="group flex items-center gap-3 rounded-2xl border-2 border-emerald-300 bg-emerald-50 px-8 py-4 text-lg font-bold text-emerald-800 shadow-lg hover:border-emerald-400 hover:bg-emerald-100 transition-all"
              >
              ...
              <button
                onClick={() => downloadScript('ai-rewritten-script.txt', [
                  rewrittenScript.title,
                  rewrittenScript.hook,
                  rewrittenScript.intro,
                  rewrittenScript.main_script,
                ...
                className="group flex items-center gap-3 rounded-2xl bg-linear-to-r from-emerald-600 to-emerald-700 px-8 py-4 text-lg font-bold text-white shadow-2xl hover:from-emerald-700 transition-all"
              >
                <Download className="h-5 w-5" />
                Download Rewrite
              </button>
      ...
      <section className="mt-12">
        ...
        <AdUnit
          adSlot="2345678901"
          adFormat="rectangle"
          className="min-h-70 rounded-[28px] border border-gray-200/50 bg-white p-8 shadow-xl"
        />
      </section>
      ...
      <section className="mt-20 grid gap-8 md:grid-cols-3">
        {[
          { icon: <Zap className="h-12 w-12 text-yellow-500 drop-shadow-lg" />, title: "⚡ Ultra Fast", desc: "2-5 seconds में script ready" },
          { icon: <Shield className="h-12 w-12 text-green-500 drop-shadow-lg" />, title: "🔒 Private", desc: "100% secure, कोई data save नहीं होता" },
          { icon: <Sparkles className="h-12 w-12 text-purple-500 drop-shadow-lg" />, title: "✨ AI Rewrite", desc: "Gemini AI से fresh script बनाएं" },
        ].map((feature, i) => (
